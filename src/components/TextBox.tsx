      ...
      <div className="row">
        ...
        <form className="form-div__form">
          <div id="urls-form-input" className="input-field">
            <AutoTextArea
              onInput={this.props.handelOnChange}
              name="url"
              id="url"
              className="materialize-textarea validate"
            ></AutoTextArea>
            <span className="helper-text" data-error="Wrong URl or URLs">
              write a list of the web pages which you would like to reference
            </span>
          </div>
          <div className="col">
            <button
              onClick={this.props.handelClickSummit}
          ...
          <div className="col">
            <button
              onClick={this.props.handelClickClear}
